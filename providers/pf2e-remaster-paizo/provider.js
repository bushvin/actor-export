...
character.activities.forEach((a) => {
    ...
    if (typeof y !== 'undefined' && a.type === 'action') {
        ...
        mapper.textBox(ref, fileName, 2, 408, y - 8, 8, 8, pf2eHelper.evalCheckMark(a.type === 'free'), mf_8_centered);
        const isReaction = a.type === 'reaction';
        mapper.textBox(ref, fileName, 2, 408, y + 2, 8, 8, pf2eHelper.evalCheckMark(isReaction), mf_8_centered);
